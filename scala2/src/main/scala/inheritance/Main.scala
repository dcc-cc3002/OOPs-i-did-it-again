...
object Main {
  def main(args: Array[String]): Unit = {
    ...
    val blueEyes: MonsterCard = new MonsterCard("Blue Eyes White Dragon", 8, 3000, 2500)
    // Or we can use the ``Card`` superclass thanks to _subtype polymorphism_
    val darkMagician: Card = new MonsterCard("Dark Magician", 7, 2500, 2100)
    ...
    val redEyes = new MonsterCard("Red-Eyes Black Dragon", 7, 2400, 2000)
